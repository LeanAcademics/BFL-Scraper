...
Base all classifications strictly on explicit statements or clear deductive inferences from the narrative and structured fields provided. Do not speculate beyond the provided information. Each coded factor must be the best-supported explanation given the narrative, not merely a possible one. Do not infer causes from the outcome itself or from contextual circumstances that are routine in BASE jumping.

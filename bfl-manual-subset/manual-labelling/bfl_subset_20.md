# BFL Subset (20) — Manual Labelling

## 1. BFL269 — Dave Buchanan
...
> The jumper in this Fatality was flying an Aura wingsuit, exit point Aiguille du Midi 3842m 09/09/2015 13:28 winds at exit: light <5kph
Dave was current having more than 60 Brevent flights in the previous month + other hiked jumps.
He loved flying terrain but did so in a conservative style usually following more experienced jumpers from a safe distance in order to learn a line. This is what Dave had done on this line later flying it solo as on the jump that took his life. He exited later in the group of 14 wingsuiters at the exit that did a mix of group jumps & solos. The first jumper came back for a second run & spotted Daves canopy open on a technical part of the line amongst mixed rock & small trees just below the tree line.
Rescue was called immediately upon landing. He was dead upon their arrival.The rescuer later stated there was an obviously impact spot through a small tree/bush 50m uphill from where Dave was found.
...
- **L0 (Top-Level):** 
- 003II - Not enough information to determin human error or non-human cause
- **L1 (Unsafe Acts):** 
- **L2 (Preconditions):** 
- **Notes:** 
...
- **Possible Factors:** Emergency low pull, Gear failure, Pilot Chute Entanglement - PC in tow
...
- **L0 (Top-Level):** 
- 003II - We have a hypothetical scenario but it is not enough information to determine Human factor or other cause
- **L1 (Unsafe Acts):** 
- **L2 (Preconditions):** 
- **Notes:** 
...
- **L0 (Top-Level):** 
- 003II - However, infering HE and Performance Error is possibly defensible.
- **L1 (Unsafe Acts):** 
- **L2 (Preconditions):** 
- **Notes:** 
...
- **BASE Jumps:** —
- **WS BASE Jumps:** —
- **Clothing - Suit:** Unknown - Unspecified WS (Unknown Wingsuit)
- **Canopy:** —
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Winds light and variable
- **Possible Factors:** Clipped ledge after exiting, Proximity flying
- **Cause of Death:** Impact in terminal freefall
...
- **L0 (Top-Level):** 
- 001HE - inferred from the fact that she didn' pull, however 003II woultd also be defensible
- **L1 (Unsafe Acts):** 
...
- **Age:** —
- **Nationality:** France
- **Location:** Dévoluy Mountains, France
- **Object Type:** E
- **Base seasons:** —
- **Skydives:** —
- **WS Skydives:** —
...
> After a Weekend on the spot with other wingsuiters, Bryan decided to enjoy the place alone for the whole week, living in his truck, saying that place was a wingsuit paradise.
...
- 001HE
- **L1 (Unsafe Acts):**
- 102S - Was proximity flying, impact killed him, no evidence the decision was the problem, 103II could also be defensible due to little information
- **L2 (Preconditions):** 
- **Notes:** 

---

## 6. BFL480 — Francesco Drosi
...
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Low level clouds, Winds light and variable
- **Possible Factors:** 180 Offheading, Not enough forward seperation on exit, Unstable exit
- **Cause of Death:** Object strike under canopy

**Accident:**

> Francesco had an unstable exit and tumbled for about 6 seconds before an emergency pull. Canopy opened with a 180 and he impacted the wall after 2-3 seconds. He impacted the wall pretty hard an the canopy collapsed as he fell down several hundred meters. He came to rest all the way at the slope grassy area right under exit 6, where he jumped from. Rescue teams were with him within the hour where he was confirmed dead due to severe injuries.
 
...
- **L0 (Top-Level):** 
- 001HE - Unstable exit & 180 off-heading opening which is very likely human error as well
- **L1 (Unsafe Acts):** 
- 102S - Unstable Exit, possibly 180 deg. opening due to human error.
- **L2 (Preconditions):** 
- **Notes:** 
- A possibility of coding 203T due to only 1 BASE season, not coding is the better decision though as an unstable exit can happen to anyone and he has quite a lot of jumps

---

## 7. BFL392 — Jeremiah Manners
...
- **BASE Jumps:** 250
- **WS BASE Jumps:** 150
- **Clothing - Suit:** Freak 2 (Expert Wingsuit)
- **Canopy:** Hayduke Lite, 7 Cell - Vented, Squirrel
...
Two lessons:(1) fist bump is sacred. Check-in with your partner here and be prepared to take a step back from the edge if the vibe is off(2) always ask about your partner’s flight plan on exit. Even competent rational people have moments of poor judgement that we would not expect.
...
- 001HE
- **L1 (Unsafe Acts):** 
- 101D - Decided to first try a difficult line without knowing if the suit even allows for it
- **L2 (Preconditions):** 
- 202P1 - Did not assess the site adequately & did not have data on exits like this & Never did an easier line to get accustomed to it
- 203T - lack of WS BASE currency
- **Notes:** 

---

## 8. BFL25 — Marita Schneider
...
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Medium winds, Sunny, Winds light and variable
- **Possible Factors:** Anabatic air flow, Line twists
- **Cause of Death:** Object strike under canopy
...
- **L0 (Top-Level):** 
- 003II - can't really classify but both other options are actually valid argumentations
- **L1 (Unsafe Acts):** 
- **L2 (Preconditions):** 
- **Notes:** 
...
- **WS BASE Jumps:** —
- **Clothing - Suit:** Slick (Slick)
- **Canopy:** OSP, 7 Cell - Vented, Atair Aerodynamics, 285
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Hot with thermals producing, Sunny, Winds light and variable
- **Possible Factors:** 180 Offheading, Aerials, Line twists, Not enough forward seperation on exit
- **Cause of Death:** Object strike under canopy

**Accident:**

> Myself and Matthew had spent the last ten days jumping at both Nizhuhe glass platform and glass bridge
This was our 4th jump of the day from Nizhuhe glass platform
We geared up and made our way onto the platform. On arrival at exit we discussed the wind conditions at the LZ and made our plan of landing direction and landing area
We then spoke about a plan for the jump. We decided I would exit on Matty’s left side, the direction of push and also the direction of track for horizontal separation on opening. I was to also pull higher than Matty for vertical separation on opening
I was to do 1 front flip then into a track, and Matty was to do 3 gainers then into a track
Matty had performed this jump already on this trip, with solid and stable rotations, catching the last rotation perfectly and tracking away from the cliff with good separation, and a safe pull hight
However on this jump, he over rotated the last rotation and ended up in a standing position, still rotating. He looked over his right shoulder and initiated a turn which put him facing towards the cliff and in a belly to earth position. He then made a 180 degree clockwise turn, facing away from the cliff and initiated a track for barely 1 second before he deployed
His canopy made line stretch and had inflated barely 1/4 when it was clear he had impacted the bush on the side of the cliff, from there as the canopy inflated more it looked like he had made hard contact with the cliff ledge while the canopy was inflating
The canopy fully inflated on heading, and matty flew away from the cliff. He reached for his toggles and landed alongside some small train tracks, on the small loose rocks. He didn’t get up when he landed and I knew I had to get to him quickly
...
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Sunny, Winds light and variable
- **Possible Factors:** No or little training, Skydive gear used
- **Cause of Death:** Skydive Gear Used

**Accident:**

> Andre is an expired USPA A license holder and an Army officer. There are three observers on the load, one is a buddy of his and the other two are girlfriends. Andre's skydiving gear sniveled to impact. There is nothing to suggest any previous BASE experience or training.
...
- 001HE
- **L1 (Unsafe Acts):** 
- 101D - used skydiving gear (normal at that time though), was only A license holder and did not have any BASE experience or training
- **L2 (Preconditions):** 
- 203T - had no training or experience in BASE
- **Notes:** 
- Not coded '202P1 - used skydiving gear' as it is already subject of the L1 Error producing the fatal outcome itself

---

## 11. BFL337 — Adam Gruenwald
...
- **BASE Jumps:** 143
- **WS BASE Jumps:** —
- **Clothing - Suit:** XXX (One Piece Tracking Suit)
- **Canopy:** —
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Winds light and variable
- **Possible Factors:** Health issues, Unable to locate pilot chute
- **Cause of Death:** Unable to pull

**Accident:**

> At this stage we have been told he was on a two way jumping last and has had some issues at pull time. We are currently waiting to hear back from the other jumper and will write more when we hear. Updated: Information from Camera Point of View is that the jumper had a very conservative jump with a reasonable high pull attempt but could not find the pc and flipped over front until impact. No other information was seen from video or by second jumper on two way.

### Manual Labels

- **L0 (Top-Level):** 
- 001HE - Simply couldn't find his PC
- **L1 (Unsafe Acts):** 
- 102S - Failed to pull
- **L2 (Preconditions):**
- **Notes:** 
Not coded '203T - Lack of skydiving experience' as this oculd happen to an experienced jumper aswell and he already had 143 BASE jumps and '201C3 (Adverse Physiological Conditions)' as Health issues only in Possible Factors is too little.
---

## 12. BFL89 — Olov Axel Kappfjell
...
- **L0 (Top-Level):** 
- 001HE - quite obvious he should not have done that
- **L1 (Unsafe Acts):** 
- 101D - it was a bad idea jumping from the middle level, only 170ft vertical drop, especially jumping stowed (50m)
- **L2 (Preconditions):** 
- 201C2 - pressure/haste/misplaced motivation: Friend decided not to jump, initially wanted to jump from the top, couldn't jump the day before
- 202P1 - jump preperation: chose to jump stowed with only a 50m vertical drop & never actually evaluated jumping from the second platform as it was not chosen
- **Notes:** 

---

## 13. BFL382 — Andrey Markelov
...
- **BASE Jumps:** 200
- **WS BASE Jumps:** —
- **Clothing - Suit:** Jedei 2 (Expert Wingsuit)
- **Canopy:** —
- **Container:** —
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Sunny, Winds light and variable
...
> On the morning of the 31st, I was part of a group of three wingsuit jumpers, we hiked up to Corna Frea, a quite technical exit point above Riva del Garda, Italy. Great visibility, north wind in the area, we made it to the exit point easily and we were not tired after the 2+ hours hike. We decided to go for a two way wingsuit jump and I was jumping second, behind the deceased jumper. This exit point can be quite intimidating, a correct push with proper heading is very important, there are clearly visible powerlines a few hundred meters below the exit point and this can make people nervous, but the deceased had already jumped from this exit point in the past and he looked ok at the exit, quite focused and committed. He jumped first and I followed, half second later. His exit looked fine, normal push, correct heading, no drastic change of angle in the recovery arc, he seemed ok, but lower than me in the early phase of the jump. A few seconds later, as he was flying toward the first ledge to the left, he made a drastic 90° turn to the right, possibly to avoid flying too close to this ledge, he then corrected his heading by turning again 90° left, back on the normal flight path, but he was, at this point, flying very low and pretty slow. He kept flying straight toward powerlines for several seconds, but unfortunately he was not high enough to fly past them and impacted on one of them, tumbling for another hundred meters until he came to a rest in the forest.

### Manual Labels

- **L0 (Top-Level):** 
- 001HE - classic flight path & emergency response miscalculation
- **L1 (Unsafe Acts):** 
- 102S - Flight path miscalculation 
- **L2 (Preconditions):**
- **Notes:** 
101D could be argued for inflight decision to turn 90 deg right and then left again, not for deciding to jump thought. -> not coded as it is not an independent decision, turns were forced to avoid the ledge

---

## 14. BFL11 — John Ray Foster
...
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Sunny, Winds light and variable
- **Possible Factors:** Unstable exit
- **Cause of Death:** Object strike under canopy
...
- 001HE
- **L1 (Unsafe Acts):** 
- 102S - Unstable exit, loss of control, unstable deploy and hitting the wall
- **L2 (Preconditions):** 
- 203T - Insufficient BASE Experience
- **Notes:** 
Didn't Code: '101D - Decided to do first BASE jump terminal, slider up, and from E' as it is not directly producing

---

## 15. BFL380 — Richard marcos González
...
- **WS BASE Jumps:** —
- **Clothing - Suit:** Slick (Slick)
- **Canopy:** Hayduke, 7 Cell - Vented, Squirrel, 250
- **Container:** Crux, 2 Pin, Squirrel
- **Packing & Setup:** Slider Down-Off; Deployment: Hand Held
- **Weather:** Sunny, Winds light and variable
...
> We had this dam on our bucket list for a long time. Finally, we found a day with a perfect forecast and low water level in the reservoir. We got up early to arrive to the place half hour before a sunrise. We were 3 jumpers.In the middle of the dam there is a fixed crane overhanging 10m from where a local company offers bungee jumping services. In the bottom, just below the crane there is a water exit to a pool. This pool extends some 60m from the dam wall and after is our primary landing zone. The pool itself is a very dangerous zone because of the water stream coming from the reservoir. To the left and right of the pool there are some small places where we could also land in case of emergency. The laser measurements gave us 95m from the top to the water. After the pool we gain vertically around 10m more.We went down to inspect the landing. Just after the pool was some low water safe landing. 60m after the pool was dry road and this is where we were heading as a main landing area. To the right from the exit point was our first emergency landing zone. To the left there wasn't much room to make a safe landing, but it was still better than landing into the pool (something consensuated by all before jumping).Shortly after we went back to the top, geared up and climbed to the edge of the crane. The feel was of no wind. We had a tiny branch each, I dropped mine and it went down in a straight vertical line. We all decided going hand-held, me first, after Riki (the rookie of the group) and then the last one. My jump went perfect, hand-held, 1 sec delay, on-heading opening and landing in the main landing area, even further than expected (approximately 140m from the dam wall). Then Riki jumped, hand-held, 1 sec delay with good body position but he had a 90º off-heading opening to the left. He corrected the heading with rear risers losing considerable vertical altitude without moving forward to the landing area; taking some precious seconds to let go his breaks. When he finally released them, he was low, but still decided to go forward for the main landing zone (we guess he thought he will make it). Unfortunately for all, he couldn’t manage to pass the pool and landed into the left corner, just few meters before its edge. The strong water stream made him disappear and we couldn’t see him anymore.It’s very difficult to tell why he wouldn’t let go the breaks sooner. Both human and gear factors may had some influence. Riki was a young, full of life and kindness, enthusiastic jumper. He will be deeply missed by all the family, friends and local skydive-BASE community members. Fly free, brother.
...
- 001HE
- **L1 (Unsafe Acts):** 
- 101D - Wrong procedure applied to a recognized situation: Wrongfully decided to attempt to reach the main landing area, to slowly released the toggles
- **L2 (Preconditions):** 
- 201C1 - Task Saturation
- 203T - Too little experience for correct response (not very clear though)
- **Notes:** 

---

## 16. BFL55 — Fred Nicolas Tussinggardel
...
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Sunny, Winds light and variable
- **Possible Factors:** No or little training, Not enough forward seperation on exit, Unstable exit
- **Cause of Death:** Impact subterminal (near exit)
...
- **L0 (Top-Level):** 
- 001HE - pretty much everything
- **L1 (Unsafe Acts):** 
- 101D - like everything was wrong
- 102S - failed stable exit
- **L2 (Preconditions):** 
- 202P1 - Fully planned this wrong
- 203T - Most clear of all, especially lack of specific Training
- 201C2 - Overconfidence, this is above and beyond what a reasonable jumper would have done
- **Notes:** 

---

## 17. BFL19 — Jean-Marc Boivin
...
- 001HE
- **L1 (Unsafe Acts):** 
- 101D - Decided to use very much unsuitable equipment
- **L2 (Preconditions):** 
- 202P1 - Selection of wrong equipment (borderline doublecounting but arguing L1 is chosing skydiving gear and L2 is chosing even unsuitable skydiving ger)
- **Notes:** 

---

## 18. BFL51 — Andrea Quarisa
...
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Winds light and variable
- **Possible Factors:** Extracted Pilot Chute too late, Focusing on filming
- **Cause of Death:** Low pull

**Accident:**

> Andrea over delayed in a back to earth position while filming two (2) other jumpers. He impacted the talus as his canopy is opening.
...
- 001HE - low pull
- **L1 (Unsafe Acts):**
- 102S - Attention Failure 
- **L2 (Preconditions):** 
- 201C1 - Channelized Attention
- **Notes:** 

---

## 19. BFL510 — Lorenz Werner
...
- **BASE Jumps:** 600
- **WS BASE Jumps:** 500
- **Clothing - Suit:** Aura 4 (Expert Wingsuit)
- **Canopy:** Troll, 7 Cell - Vented, Atair Aerodynamics, 285
- **Container:** LD5 UL, 2 Pin, Adrenalin BASE
- **Packing & Setup:** Slider Up; Deployment: BOC
- **Weather:** Sunny, Winds light and variable
...
> Lorenz and I drove together to Fürenalp and met up with another jumper at the gondola station. All three of us were well-rested and the mood was very good. We took the gondola up the mountain and hiked down to the exit together where we put our gear on. There were three of us standing at the exit. Lorenz jumped off first. We assumed that he was just flying straight out and opening high because the first jump was with his new LD5 rig that he had never jumped before. But, then he turned right and flew towards the gondola station and parking lot instead of to the standard landing area. We watched his flight and talked about how slow it looked, but it could also have been because of the headwind.
Then I could see him reaching backwards to try to get to his PC. At the same moment, he dipped his right shoulder, tipped forward, and dove head down. From that moment on, it was about two to three seconds until impact. About one to one and a half seconds before impact, I saw the red canopy come out of the container. Lorenz was too low for the parachute to deploy, so he spiraled into the bed of the stream next to the footpath without an open canopy. When we got to him, he was lying in the bed of the stream with the stretched lines and parachute next to him.
The factors that contributed to this accident were (1) deploying the parachute too late, (2) not being able to find the PC handle on his new LD5 as his previous Zack rig’s BOC was in a different place, and (3) not being very current at the moment. The last years he jumped a lot and he was highly current but that year he had been focusing on a paragliding course and not BASE jumping as much as he used to. With regard to the initial missed pull, I, personally, had the same experience with the LD5 -- that if the body position wasn't 100% correct, it was difficult to get to the PC.
...
- **L2 (Preconditions):** 
- 203T - New gear, uncurrent BASE jumper
- 202P1 - Jumped new rig with insufficient familiarity before the jump
- **Notes:** 
Not coded 101D flying advanced line with a new rig while uncurrent as it is not actually producing
---

## 20. BFL34 — Theresa Tran
...
- **Weather:** Sunny, Winds light and variable
- **Possible Factors:** Gear failure, Incorrect rigging setup, Pilot Chute Entanglement - PC in tow
...
Theresa is a live wire to all who knew her. She is a local radio personality under the name of Gina Davis and is responsible for the first ever corporately sponsored BASE jumps she organized for one of Magic Mountain's opening days in California. Theresa and I are room-mates and she is missed by all who knew her.
If you have a picture, or more details of this jumper, please contact us.
...
- 001HE
- **L1 (Unsafe Acts):** 
- 101D - Decided on incorrect deployment setup (judgement)
- **L2 (Preconditions):** 
- **Notes:** 
Did not code '202P1 - Inadequate equipment configuration' due to direct double counting

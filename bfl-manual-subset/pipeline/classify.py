#!/usr/bin/env python3
"""
HFACS-BASE Manual-Subset Classification Pipeline.

Mirrors synthetic-data-pipeline/v7 (Opus 4.6, temperature 0.3) but runs over
the 20-record manual-labelled BFL subset.
...
103II. For L2, the L1 result is injected into the user message so the cached
system block stays identical across records.
"""
...
# ---------------------------------------------------------------------------
# Configuration — identical to v7 main run
# ---------------------------------------------------------------------------
...
INPUT_FILE = RUN_DIR / "bfl-subset.jsonl"
...
def main():
    parser = argparse.ArgumentParser(description="HFACS-BASE manual-subset classification")

#!/usr/bin/env python3
"""
HFACS-BASE Synthetic Validation Pipeline — v6.

Prompt files are split from HFACS-Full-v6 and live at the folder root:
...
L1 insufficient-info category is 103II (not 104II). L2 is skipped when every
L1 act is 103II (no identified unsafe act to hang preconditions on).
...
def main():
    parser = argparse.ArgumentParser(description="HFACS-BASE synthetic validation — v6")

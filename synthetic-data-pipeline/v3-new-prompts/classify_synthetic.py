#!/usr/bin/env python3
"""
HFACS-BASE Synthetic Validation Pipeline — new-prompts / no-thinking / temp=0.3.

Isolated run under claude-new-prompts-no-thinking-temp0.3/. Reads prompts from
the LOCAL ./prompts/ folder (the revised HFACS-BASE-NEW-FULL-CLAUDE prompts),
domain context from the main classification-pipeline, and the shared
synthetic-bfl input. Writes all outputs into ./output/ within this subfolder.

#!/usr/bin/env python3
"""
HFACS-BASE Synthetic Validation Pipeline — no-thinking / temp=0.3 variant.

Isolated run under claude-no-thinking-temp0.3/. Reads prompts and domain
context from the main classification-pipeline and the shared synthetic-bfl
input. Writes all outputs into ./output/ within this subfolder.
